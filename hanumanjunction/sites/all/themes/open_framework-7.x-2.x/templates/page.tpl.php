...
<div id="main" class="clearfix main" role="main">
  <div class="container">
    ...
    <?php endif; ?>
      <div class="bottom row-fluid main-lower">
        <div class="span2 bottom_one">
          <?php print render($page['bottom_one']); ?>
        </div>
        <div class="span3 bottom_two">
          <?php print render($page['bottom_two']); ?>
        </div>
        <div class="span3 bottom_three">
          <?php print render($page['bottom_three']); ?>
        </div>
        <div class="span3 bottom_four">
...
<audio controls autoplay loop>
 <source src="/sites/default/files/hanuman_mantra.mp3" type="audio/mpeg">
