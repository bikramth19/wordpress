...
<div id="content-wrap" class="container content-wrap clearfix">
    ...
    <div id="footer">
      <?php if ($page['bottom_one'] || $page['bottom_two'] || $page['bottom_three'] || $page['bottom_four'] || $page['bottom_five'] || $page['bottom_six']): ?>
      <div id="bottom" class="container clearfix">
        ...
        <?php endif; ?>
        <?php if ($page['bottom_five']): ?>
          <div class="region bottom bottom-four<?php print ' bottom-'. $bottom; ?>">
            <div class="gutter">
              <?php print render($page['bottom_five']); ?>
            </div>
          </div>
        <?php endif; ?>
        <?php if ($page['bottom_six']): ?>
          <div class="region bottom bottom-four<?php print ' bottom-'. $bottom; ?>">
            <div class="gutter">
              <?php print render($page['bottom_six']); ?>
            </div>
          </div>
        <?php endif; ?>
      </div>
