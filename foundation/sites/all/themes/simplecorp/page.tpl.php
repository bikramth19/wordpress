        ...
        <div id="content" class="clearfix">
            ...
            <div id="bottom-content" class="container clearfix">
                ...
                <?php if (theme_get_setting('carousel_display','simplecorp')): ?>
                                ...
                                <div class="link-holder">
                                    <div class="portfolio-item-holder">
                                        <div class="portfolio-item-hover-content">
                                            ...
                                            <a href="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/sponsor-meal.jpg" title="title" data-rel="prettyPhoto" class="zoom">View Image</a>
                                            
                                           <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/sponsor-meal.jpg" alt="" width="220"  class="portfolio-img" />  
                                    ...
                                    <div class="description">
                                        <p>
                                            <a href="#" title="title">Donate to make Happy others</a>
                                        </p>
                                        <span>We only focus on the child & old age.</span>
                                    </div>
                                </div>
                            </div>
                        </li>
                                ...
                                <div class="link-holder">
                                    <div class="portfolio-item-holder">
                                        <div class="portfolio-item-hover-content">
                                            ...
                                            <a href="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/children.jpg" title="title" data-rel="prettyPhoto" class="zoom">View Image</a>
                                            
                                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/children.jpg" alt="" width="220" class="portfolio-img" />
                                ...
                                <div class="link-holder">
                                    <div class="portfolio-item-holder">
                                        <div class="portfolio-item-hover-content">
                                            ...
                                            <a href="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/elderly.jpg" title="title" data-rel="prettyPhoto" class="zoom">View Image</a>
                                            
                                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/elderly.jpg" alt="" width="220" class="portfolio-img" />
                                ...
                                <div class="link-holder">
                                    <div class="portfolio-item-holder">
                                        <div class="portfolio-item-hover-content">
                                            ...
                                            <a href="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/old-age.jpg" title="title" data-rel="prettyPhoto" class="zoom">View Image</a>
                                            
                                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/old-age.jpg" alt="" width="220" class="portfolio-img" />
                                ...
                                <div class="link-holder">
                                    <div class="portfolio-item-holder">
                                        <div class="portfolio-item-hover-content">
                                            ...
                                            <a href="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/sponsor-a-meal.jpg" title="title" data-rel="prettyPhoto" class="zoom">View Image</a>
                                            
                                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/sponsor-a-meal.jpg" alt="" width="220" class="portfolio-img" />
                                ...
                                <div class="link-holder">
                                    <div class="portfolio-item-holder">
                                        <div class="portfolio-item-hover-content">
                                            ...
                                            <a href="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/volunteer.jpg" title="title" data-rel="prettyPhoto" class="zoom">View Image</a>
                                            
                                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/volunteer.jpg" alt="" width="220" class="portfolio-img" />
                                ...
                                <div class="link-holder">
                                    <div class="portfolio-item-holder">
                                        <div class="portfolio-item-hover-content">
                                            ...
                                            <a href="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/physical.jpg" title="title" data-rel="prettyPhoto" class="zoom">View Image</a>
                                            
                                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/physical.jpg" alt="" width="220" class="portfolio-img" />
                                ...
                                <div class="link-holder">
                                    <div class="portfolio-item-holder">
                                        <div class="portfolio-item-hover-content">
                                            ...
                                            <a href="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/education.jpg" title="title" data-rel="prettyPhoto" class="zoom">View Image</a>
                                            
                                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/feature/education.jpg" alt="" width="220" class="portfolio-img" />
                    ...
                    <a href="/donate" class="colored" title="portofolio">Donate Now</a> 
        ...
        <footer id="footer">
            ...
            <div id="footer-bottom">
                <div class="container clearfix">
                    ...
                    <div class="credits">
                    Copyright &copy; 2015, Pearl Foundation 
                    </div>
